...
async def send_testimonial(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    elif index == 5:  # Шестой отзыв (отдельное видео)
        keyboard = [
...
# 14. Кнопка "🎁 Ексклюзив для турагентів✨" (бывшая "Я турагент")
...
# Обработка кнопки "Следующий отзыв турагента 2"
async def next_agent_testimonial_2(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    """Handle next agent testimonial 2 button press."""
    query = update.callback_query
    await query.answer()
    
    # Увеличиваем индекс отзыва
    current_index = context.user_data.get("agent_testimonial_index", 1)
    next_index = current_index + 1
...
# Обработка кнопки "Следующий отзыв турагента 3"
async def next_agent_testimonial_3(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    """Handle next agent testimonial 3 button press."""
    query = update.callback_query
    await query.answer()
    
    # Увеличиваем индекс отзыва
    current_index = context.user_data.get("agent_testimonial_index", 2)
    next_index = current_index + 1
...
# Обработка кнопки "Следующий отзыв турагента 4"
async def next_agent_testimonial_4(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    """Handle next agent testimonial 4 button press."""
    query = update.callback_query
    await query.answer()
    
    # Увеличиваем индекс отзыва
    current_index = context.user_data.get("agent_testimonial_index", 3)
    next_index = current_index + 1
...
# Обработка кнопки "Следующий отзыв турагента 5"
async def next_agent_testimonial_5(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    """Handle next agent testimonial 5 button press."""
    query = update.callback_query
    await query.answer()
    
    # Увеличиваем индекс отзыва
    current_index = context.user_data.get("agent_testimonial_index", 4)
    next_index = current_index + 1
...
# Обработка кнопки "Следующий отзыв турагента 6"
async def next_agent_testimonial_6(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    """Handle next agent testimonial 6 button press."""
    query = update.callback_query
    await query.answer()
    
    # Увеличиваем индекс отзыва
    current_index = context.user_data.get("agent_testimonial_index", 5)
    next_index = current_index + 1
...
def main() -> None:
    ...
    application.add_handler(CallbackQueryHandler(next_agent_testimonial_2, pattern="^next_agent_testimonial_2$"))
    application.add_handler(CallbackQueryHandler(next_agent_testimonial_3, pattern="^next_agent_testimonial_3$"))
    application.add_handler(CallbackQueryHandler(next_agent_testimonial_4, pattern="^next_agent_testimonial_4$"))
    application.add_handler(CallbackQueryHandler(next_agent_testimonial_5, pattern="^next_agent_testimonial_5$"))
    application.add_handler(CallbackQueryHandler(next_agent_testimonial_6, pattern="^next_agent_testimonial_6$"))
